...
// Example:
//
//	go build -ldflags "-X github.com/mab-go/sheets-mcp/internal/version.Version=1.0.0 \
//	  -X github.com/mab-go/sheets-mcp/internal/version.Commit=$(git rev-parse HEAD) \
//	  -X github.com/mab-go/sheets-mcp/internal/version.Date=$(date -u +%Y-%m-%d)" ./cmd/sheets-mcp
package version
